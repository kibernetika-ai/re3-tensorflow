...
serving.load_model('./models/re3/re3.pb',inputs='Placeholder:0', outputs='re3/fc6/Reshape:0')
...
NUM = 100
for i in range(NUM):
    input1 = np.random.randn(2,227, 227,3)
    #input2 = np.random.randn(1, 227, 227,3)
    start = time.time()
    outputs = serving.predict({'Placeholder:0': input1})
    out = outputs['re3/fc6/Reshape:0']
    #print(out.shape)
